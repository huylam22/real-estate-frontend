  ...
  return (
    <section className="page-container">
      <div className="flex flex-col items-center justify-center lg:relative -translate-y-10 lg:p-7 p-4">
        <span className="lg:absolute bg-red-400 rounded-lg w-5 h-1 lg:-translate-y-72 -translate-y-16"></span>
        <h1 className="absolute text-center font-bold lg:text-[200px] text-[120px] opacity-[3%] -z-10 lg:-translate-y-2/4 -translate-y-2/3">
          Our Story
        </h1>
        <span className="mb-5 rounded-full bg-green-200 py-2 px-5 text-green-600 font-bold">
          {" "}
          OUR STORY
        </span>
        <h1 className="text-primary text-4xl mb-10 text-center">
        ...
        <div className="lg:flex lg:flex-row flex flex-col gap-y-2 lg:gap-x-10 text-center">
          <div className="flex flex-col px-[80px] bg-secondary bg-opacity-5  py-10 rounded-lg">
            <h3 className="text-primary font-semibold text-3xl mb-5">
              15 Years
            </h3>
            <p className="text-primary font-light text-sm">In Business</p>
          </div>
          <div className="flex flex-col bg-secondary bg-opacity-5  px-[80px] py-10 rounded-lg">
            <h3 className="text-primary font-semibold text-3xl mb-5">
              $1 Billion
            </h3>
